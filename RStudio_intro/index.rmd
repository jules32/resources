...
**If R were an airplane, RStudio would be the airport**, providing you with access to the plane along with many, many supporting services that enable you to take off and go to awesome places. Here are the main features to look at as we walk through the IDE together. (IDE stands for integrated development environment.) Check out the [webinar](https://www.rstudio.com/resources/webinars/) and [RStudio IDE cheatsheet](https://www.rstudio.com/resources/cheatsheets/) for more.
