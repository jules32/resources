...
**If R were an airplane, RStudio would be the airport**, providing you with access to the plane along with many, many supporting services so you can take off and go to awesome places. Sure, you can use the airplane without an airport, but having that infrastructure and support is a game-changer for you, the pilot, and this is why. 
